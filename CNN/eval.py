...
tf.flags.DEFINE_string("checkpoint_dir", "./runs/1481549603/checkpoints", "Checkpoint directory from training run")
...
x_raw = data_helpers.load_data_test(FLAGS.test_data_file)
