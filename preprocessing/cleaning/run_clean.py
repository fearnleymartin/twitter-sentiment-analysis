...
def process_tweets_to_file_test(test_tweets):
    """ Create cleaned version of both sets of tweets and save to file"""
    processed_test_tweets = process_tweets(test_tweets)
    with open('test_full_cleaned.txt', 'w', encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    # process_tweets_to_file_test(test_tweets)
