...
from Files_Clement.helpers import progress

def words(text): return re.findall(r'\w+', text.lower())

WORDS = Counter(words(open('Files_Clement/words_light.txt').read()))
...
def SpellCheck (tweets, spellCheckFile = 'Files_Clement/spellcheck.txt'):
